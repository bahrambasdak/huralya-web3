          ...
          <div className="scrollable-section">
            <div className="scroll">
              <div className="section plan-section">
                ...
                <p className="text">
                  The mint price of Squirrel nfts increases by 100 lya every
                  month , So most likely you can sell your nfts at a higher
                  price every month
                </p>
              </div>
              ...
              <div className="section">
                ...
                <p className="text">
                  <p>
                    ...
                    staking nfts for up to one year. In the 10th month, you have
                    a valuable NFT that is risk free for you!!
                  </p>
                  <AiOutlinePlus className="icon" />
                </p>
              </div>
